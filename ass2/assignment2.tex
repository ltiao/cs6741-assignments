...
If $d = 1$, then Wahlstr\"{o}m's algorithm \cite{Wahlstrom:2008:TBC:1789694.1789713} guarantees that a polynomial amount of space is taken and the time complexity if $O^*(1.2377^n)$. Furthermore, since \#\textsc{Independent Set} is a polynomial-space branching algorithm, then this case of \textsc{\# Packing} is also a polynomial space branching algorithm.
