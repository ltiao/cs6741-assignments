...
\author{Edward Lee, Han Zhou, Louis Tiao}
...
For completeness and later reference, we will briefly describe the \textsc{Packing} , $d$-\textsc{Packing}, \#\textsc{Packing} and \textsc{Packing Colouring} problems presented for this assignment.
